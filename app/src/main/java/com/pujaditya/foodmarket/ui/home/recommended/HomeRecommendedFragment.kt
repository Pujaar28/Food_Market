...
import com.pujaditya.foodmarket.databinding.FragmentHomeRecommendedBinding
...
class HomeRecommendedFragment : Fragment() ,HomeNewTasteAdapter.ItemAdapterCallback{
    ...
    private lateinit var binding: FragmentHomeRecommendedBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentHomeRecommendedBinding.inflate(inflater, container, false)
        return binding.root
     }
